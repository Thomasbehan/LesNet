...
class SkinCancerDetector:
    ...
    def build_model(self, num_classes=2):
        ...
        self.model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.00001),
                           loss=focal_loss(),
                           metrics=[
                               Recall(name='recall'),
    ...
    def train_model(self, train_generator, val_generator, epochs=1000, patience_lr=10,
                    patience_es=30, min_lr=1e-8, min_delta=1e-4, cooldown_lr=5, class_weights=None):
        self._check_model()
