...
def triage_class_weights(triage_labels, malignant_cost=4.0, malignant_index=2):
    """Inverse-frequency weights with an extra multiplier on the malignant class."""
    ...
    weights[malignant_index] *= malignant_cost
